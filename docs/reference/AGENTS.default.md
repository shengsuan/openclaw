---
summary: "Default Clawer agent instructions and skills roster for the personal assistant setup"
read_when:
  - Starting a new Clawer agent session
  - Enabling or auditing default skills
---

# AGENTS.md — Clawer Personal Assistant (default)

## First run (recommended)

Clawer uses a dedicated workspace directory for the agent. Default: `~/.openclaw/workspace` (configurable via `agents.defaults.workspace`).
...
- For browser-driven verification, use `openclaw browser` (tabs/status/screenshot) with the Clawer-managed Chrome profile.
